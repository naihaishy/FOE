...
CREATE TABLE `tp_auth_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户组表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 112 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '规则表' ROW_FORMAT = Fixed;
...
CREATE TABLE `tp_chat_room`  (
  ...
  `messages` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '历史消息 json\r\nuid: rid: content: time: ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '聊天室  双人聊' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_course`  (
  ...
  `title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '课程名称',
  `subtitle` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程副标题',
  `category_id` int(11) NOT NULL DEFAULT 0 COMMENT '分类id',
  `status` enum('draft','published','closed') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'closed' COMMENT '课程状态',
  ...
  `require_skills` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '需要知识 ',
  `picture_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程图像的地址',
  `picture_name` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程图像的名字\r\n分类slug+课程name+time()',
  ...
  `has_checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否已经被审核过了 ',
  `need_check` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否提交了审核',
  `uncheck_reason` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '未通过审核原因',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tp_course_bulletin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程公告' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_course_category`  (
  ...
  `name` varchar(35) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分类名称',
  `slug` varchar(37) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分类别名 英文',
...
) ENGINE = MyISAM AUTO_INCREMENT = 39 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程章节表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_course_discuss`  (
  ...
  `post_time` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程讨论' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_course_discuss_reply`  (
  ...
  `post_time` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程讨论回复' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_course_files`  (
  ...
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件描述',
  `uri` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件uri',
  `size` int(12) NOT NULL COMMENT '文件大小',
  `type` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'video' COMMENT '文件类型',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 113 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程文件' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程关注' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_course_lesson`  (
  ...
  `course_id` int(11) NULL DEFAULT NULL COMMENT '所属课程 id',
  ...
  `status` enum('unpublished','published') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'unpublished' COMMENT '课时状态',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课时标题',
  `type` enum('video','audio','test','text') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'video' COMMENT '课时类型',
  `summary` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课时摘要',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课时正文',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 50 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程课时表 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_course_lesson_learn`  (
  ...
  `status` enum('learning','finished') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学习状态',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id_course_id`(`user_id`, `course_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课时学习记录表' ROW_FORMAT = Fixed;
...
CREATE TABLE `tp_course_paper`  (
  ...
  `title` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '试卷标题',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '试卷描述',
  `type` enum('auto','hand') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'auto' COMMENT '试卷类型 \r\nauto 自动生成\r\nhand 手动添加',
  `questions_list` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手工组卷时 为 题目列表 系统自动组卷为空',
  ...
  `status` enum('open','closed') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'closed' COMMENT '状态 默认关闭',
  `settings` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '试卷设置 \r\n诸多设置\r\n',
  `paper_start_date` int(11) UNSIGNED NOT NULL COMMENT '开始时间',
  `paper_end_date` int(11) UNSIGNED NOT NULL COMMENT '结束时间',
  `time_limit` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '时间限制 ',
  ...
  `gener_method` enum('random','difficulty') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'random',
  `diff_setting` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `exam_range` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '出题范围',
  `exam_categ_setting` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '题目各类数目及分值设置',
  `question_sort` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '题型排序',
  `exam_password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '题目访问密码',
  `limit_net_addr` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 64 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '试卷表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for tp_course_paper_test
-- ----------------------------
DROP TABLE IF EXISTS `tp_course_paper_test`;
CREATE TABLE `tp_course_paper_test`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `paper_id` int(11) UNSIGNED NOT NULL,
  `user_id` int(11) NOT NULL,
  `answer` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `result` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '每道题结果',
  `score` int(11) NOT NULL COMMENT '分数',
  `post_time` int(11) NOT NULL,
  `has_reviewed` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '试卷回答和结果' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_course_question`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '题目类型',
  `stem` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '题干',
  `metas` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '元信息 保存选项 判断项等内容',
  `answer` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '参考答案',
  `analysis` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解析',
  `difficulty` enum('easy','normal','hard') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '题目备注 ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 75 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '题目表记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_email`  (
  ...
  `subject` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '正文内容',
  ...
  `status` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'normal' COMMENT '邮件状态\r\n1 普通邮件 normal\r\n2 垃圾邮件 trash\r\n3星标邮件 star\r\n4 草稿邮件 draft',
  `tags` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标签',
  `category` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '站内信 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_files`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件名',
  `type` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件类型',
  `size` int(11) NOT NULL COMMENT '大小 byte',
  `uri` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件保存路径',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件描述',
  `upload_user` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '上传人 uid,role\r\njson 格式',
  `upload_time` int(11) NOT NULL COMMENT '上传时间',
  `domain` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文件所属域\r\nmanual 手册\r\nforum  论坛\r\nnews   新闻\r\nuser    用户\r\nlive     直播\r\nchat    聊天\r\nemail 站内信\r\ncourse已经单独放置一张表 最常用',
  `access_role` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '访问权限角色\r\n0 all\r\n1 admin\r\n2 teacher \r\n3 student\r\n4 visitor\r\n',
  `password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访问密码',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 55 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件记录表--普通文件' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_forum`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '板块名',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '板块描述',
  `pid` int(11) NOT NULL COMMENT '父板块id',
  `status` enum('close','open') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'open' COMMENT '状态',
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'fontawesome 图标',
  `slug` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '别名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '论坛 板块记录表' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_forum_post`  (
  ...
  `title` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容',
  `user_id` int(11) NOT NULL COMMENT '用户 id',
  `role_id` int(11) NOT NULL COMMENT '角色 id \r\n教师 管理员 学生均可发帖 回帖',
  `created_time` int(11) NOT NULL COMMENT '创建时间',
  `updated_time` int(11) NULL DEFAULT NULL COMMENT '最后更新时间',
  `attachment_id` int(11) NULL DEFAULT NULL COMMENT '附件id 多个文件请压缩打包',
  ...
  `status` enum('essence','stick','normal') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'normal' COMMENT '帖子状态\r\nnormal 正常  默认 \r\nstick 置顶\r\nessence 精华',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '论坛帖子表' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_forum_reply`  (
  ...
  `metas` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '元信息',
  ...
  `quotes` int(11) NULL DEFAULT NULL COMMENT '引用回复id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '论坛帖子回复' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_forum_upvote`  (
  ...
  `role_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '点赞表' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_lesson_answers`  (
  ...
  `answer` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `post_time` int(11) NOT NULL,
  `metas` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '元信息',
...
CREATE TABLE `tp_lesson_materials`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课时资料表' ROW_FORMAT = Fixed;
...
CREATE TABLE `tp_lesson_notes`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课时笔记表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_lesson_questions`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '问题表' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_live`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '直播间名称',
  ...
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'open' COMMENT '状态\r\n指的是该次直播的状态 open正常进行 \r\nclosed关闭',
  ...
  `poster_uri` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '封面uri',
  `poster_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '海报文件名',
  `tags` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标签',
  `is_over` smallint(2) NOT NULL COMMENT '是否已经结束',
  `rtmp_keys` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'rtmp url key',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否通过审核',
  `has_checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否已经被审核过了 ',
  `uncheck_reason` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '未通过审核原因',
  `vod_uri` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '直播表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_live_category`  (
  ...
  `count` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '直播分类' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_live_chat_message`  (
  ...
  `live_id` int(11) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tp_live_room`  (
  ...
  `status` enum('normal','banned') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'normal' COMMENT '直播间状态\r\nnormal 正常\r\nbanned 封禁',
  `collect_num` int(11) NOT NULL COMMENT '收藏人数',
  `rtmp` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'rtmp://fms.zhfsky.com/live' COMMENT 'RTMP推流地址'
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '直播间信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_manual`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `type` enum('admin','teacher','student','common') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'common' COMMENT '类型\r\n教师\r\n管理员\r\n学生\r\n公共',
  `created_user` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人 uid,rid',
  `created_time` int(11) NOT NULL,
  `updated_time` int(11) NOT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手册简介',
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'open' COMMENT '状态',
  `category_id` int(11) UNSIGNED NOT NULL COMMENT '所属类别id',
  `tags` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标签',
  `views` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '查看数目',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '手册表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_manual_category`  (
  ...
  `name` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'category name',
  `slug` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '别名 英文',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '手册类型记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_messages`  (
  ...
  `post_time` int(11) NOT NULL COMMENT '发送时间',
  `type` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消息类型\r\nsystem 系统消息\r\nforum 论坛消息\r\ncourse课程消息\r\naccount 账户消息 ',
  `status` enum('read','unread') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'unread' COMMENT '读取状态',
  `event` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '事件\r\n',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 358 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统消息|通知 来自系统 短消息 非站内信' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_news`  (
  ...
  `category_id` int(11) NOT NULL COMMENT '分类id',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `author` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '发布人id',
  `tags` int(12) NULL DEFAULT NULL COMMENT '标签id',
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'publish' COMMENT '状态\r\n',
  `post_time` int(11) NOT NULL COMMENT '发表时间',
  `updated_time` int(11) NOT NULL,
  `views` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '新闻 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_news_category`  (
  ...
  `views` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '新闻分类表' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_oj_problem`  (
  ...
  `title` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '题目标题',
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '题目描述',
  ...
  `sample_input` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '样板输入',
  `sample_output` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '样本输出',
  `spj` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT 'special oj',
  ...
  `in_date` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `accepted` int(11) NULL DEFAULT 0 COMMENT '结果接受次数',
  `submit` int(11) NULL DEFAULT 0 COMMENT '提交次数',
  `solved` int(11) NULL DEFAULT 0 COMMENT '解决次数',
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'open' COMMENT '公开|私有',
  PRIMARY KEY (`problem_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1022 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'OJ系统题目表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_oj_solution`  (
  ...
  PRIMARY KEY (`solution_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1060 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'OJ系统 solution 表' ROW_FORMAT = Fixed;
...
CREATE TABLE `tp_oj_source_code`  (
  ...
  `source` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '代码',
  PRIMARY KEY (`solution_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Oj系统的source code表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_relation`  (
  ...
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'friend \r\nfollow\r\n',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户关系表 \r\n好友 关注 ' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_setting`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '键',
  `value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '值',
  `group` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '群组',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统设置记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_sms`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tel` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `verify_code` decimal(6, 0) NOT NULL COMMENT '短信验证码',
  `send_time` int(12) NULL DEFAULT 0 COMMENT '验证码发送时间',
...
CREATE TABLE `tp_stu`  (
  ...
  `sex` char(3) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '性别',
  `email` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '电子邮箱',
  `tel` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手机号码',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '/Public/Home/uassets/img/default_avatar.png' COMMENT '用户头像',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `registered` int(11) NOT NULL COMMENT '注册时间',
  `last_login_time` int(11) NOT NULL COMMENT '最后登录时间',
  `last_login_ip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '最后登录IP',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `salt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '605c3970f09f5c0e3653f8a96247e57e' COMMENT '盐\r\n默认 md5(naihaifoe)',
  ...
  `enabled` tinyint(1) NULL DEFAULT 0 COMMENT '账户是否激活',
  `oauth_id` int(11) NOT NULL,
  `session_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `forget_send_time` int(11) NOT NULL COMMENT '忘记密码 发送token时间',
  `forget_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'forget_token',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `a`(`username`) USING BTREE
...
CREATE TABLE `tp_stu_setting`  (
  ...
  `layout` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `theme` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '邮箱订阅与通知设置',
  `privacy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '隐私设置',
  `inform` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '通知设置',
...
CREATE TABLE `tp_teacher`  (
  ...
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '教师简介',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '/Public/Home/uassets/img/default_avatar.png' COMMENT '头像uri地址',
  ...
  `access_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '账号验证 token',
  `session_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `forget_send_time` int(11) NOT NULL,
  `forget_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tp_teacher_forum`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '论坛板块标题',
  `subtitle` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '论坛板块副标题',
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '论坛板块描述',
  `pid` int(11) NOT NULL COMMENT '上级板块id',
  `domain` enum('other','general') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'general' COMMENT '板块所属域',
  `slug` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '别名',
  `status` enum('close','open') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'open' COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tp_teacher_forum_post`  (
  ...
  `created_time` int(11) NOT NULL COMMENT '创建时间',
  `updated_time` int(11) NOT NULL COMMENT '最后修改时间',
  `attachment_id` int(255) NULL DEFAULT 0 COMMENT '附件 id ',
  ...
  `status` enum('essence','stick','normal') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'normal' COMMENT '状态 正常 精华 置顶',
...
CREATE TABLE `tp_teacher_forum_reply`  (
  ...
  `metas` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '元信息',
  `attachment_id` int(11) NULL DEFAULT NULL COMMENT '附件id',
  `post_time` int(11) NOT NULL,
  `quotes` int(11) NULL DEFAULT NULL COMMENT '引用回复 id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tp_teacher_forum_upvote`  (
  ...
  `role_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '教师论坛点赞记录表' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_teacher_setting`  (
  ...
  `privacy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '隐私设置',
  `inform` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '通知设置',
  UNIQUE INDEX `tid`(`teacher_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tp_university`  (
  ...
  `name` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学校名称',
  `slug` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '英文简称',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学校简介',
  `banner` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学校封面 uri',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学校' ROW_FORMAT = Compact;
...
CREATE TABLE `tp_user`  (
  ...
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '头像uri',
  `sex` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `tel` decimal(11, 0) NOT NULL,
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `qq` decimal(25, 0) NULL DEFAULT NULL,
  ...
  `access_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '激活码',
  `access_send_time` int(11) NULL DEFAULT NULL COMMENT '激活码最后发送时间',
  `enabled` tinyint(1) NULL DEFAULT 0 COMMENT '账户是否激活',
  `locked` tinyint(1) NULL DEFAULT 0 COMMENT '账户是否被管理员锁定',
  `registered` int(11) NOT NULL COMMENT '管理人员注册日期',
  `salt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'foe' COMMENT '密盐加',
  `session_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `forget_send_time` int(11) NOT NULL,
  `forget_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
